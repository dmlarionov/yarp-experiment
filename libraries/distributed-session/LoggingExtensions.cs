...
namespace Distributed.Session
{
    internal static partial class LoggingExtensions
    {
        ...
        [LoggerMessage(7, LogLevel.Warning, "Error unprotecting the session header.", EventName = "ErrorUnprotectingHeader")]
        public static partial void ErrorUnprotectingSessionHeader(this ILogger logger, Exception exception);
        ...
        [LoggerMessage(14, LogLevel.Information, "Session key isn't unavailable.", EventName = "SessionKeyNotAvailable")]

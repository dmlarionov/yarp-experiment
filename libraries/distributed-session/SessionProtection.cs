...
namespace Distributed.Session
{
	...
	{
        public static string Protect(IDataProtector protector, string data)
        {
        ...
        public static string Unprotect(IDataProtector protector, string? protectedText)
        {
            try
            {
        ...
        public static string Unprotect(IDataProtector protector, string? protectedText, ILogger logger)
        {
            try
            {
                if (string.IsNullOrEmpty(protectedText))
            ...
            catch (Exception ex)
            {
                ...
                logger.ErrorUnprotectingSessionHeader(ex);
                return string.Empty;
            }
        }
